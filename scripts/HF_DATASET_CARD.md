...
| `Labeled_gpt-5.1/` | **Default annotations by GPT-5.1** |
| `Labeled_gpt-5.1/consolidated/` | Consolidated per-video annotations (Thought & Action NLP) |
| `Labeled_gpt-5.1/divided/planning/` | Extracted Planning knowledge per video |
| `Labeled_gpt-5.1/divided/grounding/` | Extracted Grounding knowledge per video |

Some videos additionally contain annotations from alternative models used in the annotator ablation study (Table 2b):

| Directory Name | Actual Model | Count | Purpose |
|----------------|-------------|-------|---------|
| `Labeled_gpt-5.1/` | **GPT-5.1** | 299 | Default annotations for main experiments (Table 1) |
...
| Annotated video directories | 299 |
| Total video files (MP4) | 453 |
